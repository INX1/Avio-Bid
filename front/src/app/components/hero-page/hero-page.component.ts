...
export class HeroPageComponent implements OnInit {
  constructor(private _flightService: FlightService, private _userService: UserService) { }
  ...
  onSubmit(){
    ...
    this._userService.setUserData({email: this.email, name: this.name, flightID: this._flightService.flight.flightID}).subscribe();
    this.log = true;
  }
}
