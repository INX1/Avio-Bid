...
export class RoomsComponent implements OnInit {
  ...
  constructor(private _userService: UserService, private _auctionService: AuctionService, private _flightService: FlightService, public route: ActivatedRoute) { }
  ...
  onShowRoom(roomIndex: number){
    ...
    this._auctionService.getBid(this.rooms[roomIndex].roomID).subscribe((res) => {
      res.forEach((el) => {
